...
# print(bus.read_byte(DEVICE_ADDR))             # ouputs 0
print(bus.read_byte_data(DEVICE_ADDR, DEVICE_ID))                               # get device ID
bus.write_byte_data(DEVICE_ADDR, CONFIG_1, CFG1_MODE_RGB | CFG1_10KLUX)         # configure mode & rate
bus.write_byte_data(DEVICE_ADDR, CONFIG_2, CFG2_IR_ADJUST_HIGH)                 # configure infrared filtering
bus.write_byte_data(DEVICE_ADDR, CONFIG_3, CFG_DEFAULT)                         # we don't need interrupts